...
export const seoConfig = {
  ...
  description: 'Building scalable Java backend systems with Spring Boot while integrating AI into real-world applications.',
  url: 'https://pawanraja-portfolio.rajapawanvalila.workers.dev',
  image: '/pawan-photo.jpg',
  siteName: 'Venkata Raja Pavan Kumar Reddy',
};

...
export const skillCategories = [
  ...
  { key: 'aiIntegration', label: 'AI & Tools' },
];

export const allSkillList = [
  { name: 'Java (OOP, Collections, Multithreading, Streams)', level: 95 },
  { name: 'Spring Boot & Microservices Architecture', level: 90 },
  { name: 'REST APIs & Endpoints Design', level: 92 },
  { name: 'Spring Security & JWT Authentication', level: 85 },
  { name: 'JPA / Hibernate & Data Modeling', level: 88 },
  { name: 'Spring AI & LLM Integrations', level: 80 },
  { name: 'MySQL, PostgreSQL & SQL Optimization', level: 85 },
  { name: 'Git, GitHub, Docker & Postman', level: 88 },
];
